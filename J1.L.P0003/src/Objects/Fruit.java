...
public class Fruit {
    ...
    public void createFruit() {
        ...
        System.out.print("Enter fruit name please: ");
        do {
            try {
        ...
        System.out.print("Enter fruit price please: ");
        do {
            try {
        ...
        System.out.print("Enter fruit quantity please: ");
        do {
            try {
        ...
        System.out.print("Enter fruit origin please: ");
        do {
            try {
